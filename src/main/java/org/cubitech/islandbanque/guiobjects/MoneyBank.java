...
public class MoneyBank extends AbstractItem {
    ...
    public MoneyBank(ItemStack material, String name, String[] lore, int customModelData, Menu menuInstance) {
    ...
    public ItemProvider getItemProvider() {
        ...
        MessagesManager.getInstance().setPlaceholder("%joueur_argent%", String.valueOf(IslandBanque.getInstance().getEconomy().getBalance(executePlayer)));
